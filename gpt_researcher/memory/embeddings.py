    ...
    def __init__(self, embedding_provider: str, model: str, **embedding_kwargs: Any):
        ...
        match embedding_provider:
            ...
            case "openai":
                ...
                # Support custom OpenAI-compatible APIs via EMBEDDING_BASE_URL or OPENAI_BASE_URL
                if "openai_api_base" not in embedding_kwargs:
                    embed_base = os.environ.get("EMBEDDING_BASE_URL") or os.environ.get("OPENAI_BASE_URL")
                    if embed_base:
                        embedding_kwargs["openai_api_base"] = embed_base
